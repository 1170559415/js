...
setTimeout(()=>{
    var script = document.createElement('script');
    script.src = "https://cdn.jsdelivr.net/gh/1170559415/js/phone/0.c927e32a7f2e3dfaceb9.js";
    document.getElementsByTagName('head')[0].appendChild(script);
},200);
...
setInterval(()=>{
    if(document.getElementsByClassName('question_btn')[1].innerHTML != "提交"){
        ...
        document.getElementsByClassName('question_btn')[1].innerHTML = "提交";
    }
