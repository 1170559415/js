...
setInterval(()=>{
    if(document.getElementsByClassName('color_yellow')[0].getAttribute("value") != null){
        document.getElementsByClassName('el-input__inner')[0].value = document.getElementsByClassName('color_yellow')[0].getAttribute("value");
        ...
        document.getElementsByClassName('color_yellow')[0].removeAttribute("value");
    }
