...
setInterval(()=>{
    if(document.getElementsByTagName('img').length > 6 && first){
        localStorage.setItem("mycode","null");
        localStorage.setItem("mycode2", localStorage.getItem("mycode") );
        var f_n = prompt("次数", "")
...
setInterval(()=>{
    if(localStorage.getItem("mycode") != localStorage.getItem("mycode2")){
        document.getElementsByClassName('el-input__inner')[0].value = localStorage.getItem("mycode");
