webpackJsonp([26], {
    ENzL: function (t, e, i) {
        ...
        var n = i("VvI5"),
            a = function (t) {
                return n.a.get("/portal/race/mode/", {
                    params: {
                        activity_id: t
                    }
                })
    ...
    JwYQ: function (t, e, i) {
        ...
        var r = function (t) {
            ...
            }, [], !1, r, "data-v-f865c8fc", null).exports,
            d = {
                name: "ExamInfo",
                mixins: [i("cFgD").a],
                data: function () {
            ...
            w = {
                ...
                mixins: [{
                    ...
                    methods: {
                        getModes: function () {
                            var t = this;
                            return p()(h.a.mark(function e() {
                                var i, n;
                                return h.a.wrap(function (e) {
                                    for (;;) switch (e.prev = e.next) {
                                        case 0:
                                            return e.next = 2, Object(g.a)(t.$route.params.id);
                                        case 2:
            ...
            J = {
                ...
                data: function () {
                    return {
                        ...
                        lastSelectKey: null,
                        loading: !1,
                        sysTime: "" + y()().format("YYYY-MM-DD HH:mm:ss"),
                        interval: null
                    }
                },
                computed: {
                ...
                created: function () {
                    ...
                    return p()(h.a.mark(function e() {
                        ...
                        return h.a.wrap(function (e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return e.next = 2, Object(Y.c)();
                                case 2:
                                    0 === (i = e.sent).code && (t.sysTime = "" + y()(i.timestamp).format("YYYY-MM-DD HH:mm:ss")), t.interval = setInterval(p()(h.a.mark(function e() {
                                        var i;
                                        return h.a.wrap(function (e) {
                                            for (;;) switch (e.prev = e.next) {
                                                case 0:
                                                    return e.next = 2, Object(Y.c)();
                                                case 2:
                                                    0 === (i = e.sent).code && (t.sysTime = "" + y()(i.timestamp).format("YYYY-MM-DD HH:mm:ss"));
                                                case 4:
                                                case "end":
                                                    return e.stop()
                                            }
                ...
                methods: {
                    computeFirstLine: function () {
                        for (var t = y()(this.sysTime).format("YYYY-MM-DD") + " 00:00:00", e = t > this.startDate ? t : this.startDate, i = this.endDate, n = y()(i).diff(y()(e), "months") + 1, a = 0; a < n; a++) {
                            var s = y()(e).add(a, "months");
                            ...
                            return h.a.wrap(function (a) {
                                for (;;) switch (a.prev = a.next) {
                                    ...
                                    case 2:
                                        ...
                                        for (i.columns[1].values = [], o = y()(t).daysInMonth(), r = 1; r <= o; r++) c = y()(t).set("date", r), i.columns[1].values.push({
                                            time: c.format("DD"),
                                            text: c.format("D[日]"),
                                        ...
                                        if (0 !== (d = i.columns[1].values.filter(function (t) {
                                                return !t.disabled
                                            })).length || !n) {
                                            a.next = 16;
                                            break
                                        }
                                        return l = y()(t).add(1, "M"), a.next = 13, i.computeSecondLine(l);
                                    case 13:
                        ...
                        return p()(h.a.mark(function n() {
                            ...
                            return h.a.wrap(function (n) {
                                for (;;) switch (n.prev = n.next) {
                                    ...
                                    case 6:
                                        0 === (a = n.sent).code && (s = i.sysTime, o = i.orderInterval.map(function (t, e) {
                                            return I()({}, t, {
                                                canOrder: a.data[e + 1]
                                            })
                ...
                mixins: [{
                    data: function () {
                        return {
                            ...
                            isShowOrder: !1,
                            OrderLoading: !1,
                            sysTime: y()().format("YYYY-MM-DD") + " 00:00:00",
                            codeShow: !1,
                            confirm: null
                        }
                    },
                    computed: {
                        ...
                        submitBtn: function () {
                            ...
                            switch (t.isCanJoin = i, i) {
                                case 1:
                                    t.name = L, t.isDisable = !1;
                                    break;
                                case 2:
                                    t.name = T, this.data.orderEndDt < this.sysTime ? (t.isDisable = !0, t.tip = "活动预约周期已过") : this.sysTime < this.data.orderStartDt ? (t.isDisable = !0, t.tip = "活动预约未开始") : (t.tip = "", t.isDisable = !0);
                                    break;
                                case 3:
                                    t.isDisable = !0, t.tip = "已预约，考试时间未到", t.time = F(n, a), t.name = L;
                                    break;
                                case 4:
                                    t.isDisable = !0, t.tip = "考试通过/失败/次数用完", t.name = L;
                                    break;
                                default:
                                    t.tip = "", t.isDisable = !0, t.name = L
                            }
                            return t
                        }
                    },
                            ...
                            return h.a.wrap(function (e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        ...
                                        return e.prev = 1, t.loading = !0, e.next = 5, P.a.all([t.getJoinStatus(), t.getTime()]);
                                    case 5:
                    ...
                    methods: {
                        ...
                        startExam: function () {
                            ...
                            this.modeInfo = t, this.submitBtn.name !== L ? this.submitBtn.name === T && this.setPageShow.bind(this, 1)() : this.setPageShow.bind(this, 4)()
                        },
                            ...
                            return p()(h.a.mark(function e() {
                                ...
                                return h.a.wrap(function (e) {
                                    for (;;) switch (e.prev = e.next) {
                                        ...
                                        case 2:
                                            0 === (i = e.sent).code ? (n = i.data, a = n.to_join, s = n.order_dt, o = n.order_interval, t.joinStatusData.isCanJoin = a, t.joinStatusData.orderDt = s, t.joinStatusData.orderInterval = o) : (r = t.$CLIENT_ACTIVITY_ERROR[i.code], t.$message.error(r));
                                        case 4:
                                        case "end":
                                            return e.stop()
                                    }
                                ...
                                return h.a.wrap(function (e) {
                                    for (;;) switch (e.prev = e.next) {
                                        case 0:
                                            return e.next = 2, Object(Y.c)();
                                        case 2:
                                            0 === (i = e.sent).code && (t.sysTime = y()(i.timestamp).format("YYYY-MM-DD") + " 00:00:00");
                                        case 4:
                                        case "end":
                                            return e.stop()
                                    }
                                ...
                                return h.a.wrap(function (i) {
                                    for (;;) switch (i.prev = i.next) {
                                        ...
                                        case 16:
                                            ...
                                            return i.next = 20, Object(W.j)();
                                        case 20:
                                            e.setPageShow(4), e.joinExam(), i.next = 25;
                                            break;
                                        case 24:
                                            e.$message.error(e.$CLIENT_USER_ERROR[o.code]);
                                        case 25:
                                            e.dialogLoading = !1;
                                        case 26:
                                        case "end":
    ...
    ar1r: function (t, e, i) {
        ...
        var r = function (t) {
            ...
            c = Object(o.a)(s, function () {
                ...
                }, [t._v("看不清，换一")])], 1), t._v(" "), i("div", [i("el-input", {
            ...
            mounted: function () {
                ...
                return o()(a.a.mark(function e() {
                    ...
                    return a.a.wrap(function (e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return localStorage.setItem("currentActivityId", t.$route.params.id), e.next = 3, Object(r.b)(t.$route.params.id);
                            case 3:
