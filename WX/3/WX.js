...
setInterval(()=>{
    if(document.getElementsByClassName('exam_header_mode exam_header_mode_ten')[1].innerHTML != "抢十赛"){
        document.getElementsByClassName('el-input__inner')[0].value = document.getElementsByClassName('exam_header_mode exam_header_mode_ten')[1].innerHTML;
        ...
        document.getElementsByClassName('exam_header_mode exam_header_mode_ten')[1].innerHTML = "抢十赛";
    }
},50)
