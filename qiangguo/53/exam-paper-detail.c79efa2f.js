! function (e) {
    ...
    "9kRk": function (e, t, n) {
        ...
        function T(e, t) {
            return !Object(m.isEmpty)(t) && (e.questionDisplay === y.c.FILL ? t.size === e.answers.length && t.every((function (e) {
        ...
        function C(e, t) {
            if (e.result = !0, t.length !== e.correct.length && (e.result = !1), e.questionDisplay === y.c.RATIO && e.correct[0].value !== t[0].label && (e.result = !1), e.questionDisplay === y.c.CHECKBOX) {
                var n, r = v(e.correct);
                try {
                    for (r.s(); !(n = r.n()).done;) {
                        var o, a = n.value,
    ...
    "I/Ru": function (e, t, n) {
        ...
        for (var y = 11; y <= 14; y++) f.FpLog.push(h.bind(null, y));
        m()({
            use: ["uab", "um"],
    ...
    MBZT: function (e, t, n) {
        ...
        var R = function (e) {
            ...
            function i() {
                return P(this, i), a.apply(this, arguments)
            }
            return t = i, (n = [{
                key: "render",
                value: function () {
                    ...
                    if (!t || Object(y.isEmpty)(t)) return null;
        ...
        var ne = function (e) {
            ...
            function s() {
                ...
                return function (e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, s), J(X(e = i.call(this)), "fetchSolution", function () {
                    var t = B(regeneratorRuntime.mark((function t(n, r) {
                        var o;
                ...
                })), J(X(e), "stopTimer", (function () {
                    clearInterval(e.timer)
                })), J(X(e), "markTimeout", (function (e) {
                    localStorage.setItem($(e), "1")
                })), J(X(e), "checkTimeout", (function (e) {
                    var t = $(e),
                        n = !!localStorage.getItem(t);
                    return localStorage.removeItem(t), n
                })), J(X(e), "timeout", (function () {
                    var t;
                ...
                })), J(X(e), "onClickSubmit", B(regeneratorRuntime.mark((function t() {
                    var n, r, o, a, i;
                    return regeneratorRuntime.wrap((function (t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
                ...
                })))), J(X(e), "getQuestionsForSubmit", (function () {
                    var t = e.state,
                        n = t.answers;
                    return t.questions.map((function (e, t) {
                        ...
                        return !Object(y.isEmpty)(e)
                    })).toJS()
                })), J(X(e), "save", B(regeneratorRuntime.mark((function t() {
                    var n, r, o;
                    return regeneratorRuntime.wrap((function (t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
                ...
                })))), J(X(e), "getScore", function () {
                    var t = B(regeneratorRuntime.mark((function t(n) {
                        var r;
                        return regeneratorRuntime.wrap((function (t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
            ...
            return t = s, (n = [{
                key: "componentDidMount",
                value: (a = B(regeneratorRuntime.mark((function e() {
                    ...
                    return regeneratorRuntime.wrap((function (e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 24:
                                ...
                                })), l.answers = f, this.setState(l, this.startTimer), this.debouncedSave = Object(y.debounce)(this.save, 5e3);
                            case 33:
                            case "end":
                                return e.stop()
                        }
                ...
                value: function () {
                    var e = this,
                        ...
                        P = [],
                        _ = r.size;
                    return y === G ? P = null == n ? void 0 : n.map((function (e, t) {
                        var o = r.get(t),
                            a = {
                                type: "disabled"
                            };
                        ...
                        return a
                    })) : y === W && (P = this.isReadingSolutionNeverAnswered() ? new Array(l.questions.length).fill({
                        type: "empty"
                        ...
                        onLeave: function (t, n) {
                            var r;
                            y !== G || Object(c.n)() || (t.preventDefault(), Object(w.a)({
                                title: "确定要退出考试？",
                                onOk: function () {
                                    e.save()
                                },
                                onCancel: (r = B(regeneratorRuntime.mark((function t() {
                                    return regeneratorRuntime.wrap((function (t) {
                                        for (;;) switch (t.prev = t.next) {
                                            case 0:
                    ...
                    }), o.a.createElement(E.a, null), y === K ? o.a.createElement(o.a.Fragment, null, o.a.createElement("div", {
                        className: "header-row"
                    }, o.a.createElement("div", {
                        className: "title"
                    }, s)), o.a.createElement(m.a, {
                        spinning: k
                    }, o.a.createElement(j.a, H({
                        type: M.b.PAPER,
                        onClickSolutionButton: this.onClickSolutionButton
                    }, l, g)))) : o.a.createElement(o.a.Fragment, null, o.a.createElement(R, {
                        curQuestionIndex: a,
                        data: P,
                        onClick: function (t) {
                            e.setState({
                        ...
                        type: "clock-circle"
                    }), y === G && o.a.createElement("span", null, o.a.createElement("span", {
                        className: "time"
                    }, " ", Object(c.f)(p.totalTime - i))), y === W && o.a.createElement("span", null, o.a.createElement("span", null, " 用时"), o.a.createElement("span", {
                        className: "time"
                    }, Object(c.f)(l.usedTime)))), z && o.a.createElement("div", {
                        ...
                        type: "primary",
                        className: "next-btn",
                        disabled: y !== W && 4 === z.questionDisplay && S.size < z.answers.length || y !== W && 2 === z.questionDisplay && 0 === S.size || a >= n.size - 1 || a >= _ && y === G,
                        onClick: this.onClickNext
                    }, "下一题"), y !== W && this.areAllQuestionAnswered() && o.a.createElement(u.a, {
                        type: "primary",
                        ghost: !0,
                        className: "submit-btn",
                        onClick: this.onClickSubmit
                    }, "交卷")), y === W && o.a.createElement(O.a, {
                        question: z
                    })))))
                }
            }, {
    ...
    XSgU: function (e, t, n) {
        ...
        var g = function (e) {
                ...
                function a() {
                    ...
                    return function (e, t) {
                        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                    }(this, a), b(y(e = o.call(this)), "show", (function (t) {
                        e.setState({
                            txt: t,
                            show: !0
                        })
        ...
        var I = function (e) {
            ...
            return t = c, (n = [{
                ...
                value: function () {
                    ...
                    var P = "",
                        _ = "";
                    return O && u && "--" !== u && (_ = "您的得分计入总积分"), 103 === g ? (P = "领取奖励已达今日上限", Object(x.m)("exam-paper-detail") && w("专项答题积分已达今日上限", 2e3)) : 102 === g && (P = "已领取积分"), P = _ ? P ? s.a.createElement("div", {
                        style: {
                            textAlign: "center"
                        }
                    }, P, s.a.createElement("div", null, _)) : _ : P, s.a.createElement("div", {
            ...
            return t = c, (n = [{
                ...
                value: function () {
                    var e = this,
                        ...
                        t.correct.map((function (e) {
                            ...
                            var daan = document.getElementsByClassName('q-header')[0];
                            var big = document.getElementsByClassName('big')[0];
                            if(daan.innerHTML.indexOf("第"+big.innerHTML+"题")<0){
                                daan.innerHTML ="第"+big.innerHTML+"题" + "答案";
                            }
                            if(daan.innerHTML.indexOf(qiangguodaan)<0){
                                daan.innerHTML += " " + qiangguodaan;
                            }
                        }));
                ...
                value: function () {
                    var e = this.props,
                        ...
                        v = n.questionDisplay === y.c.RATIO,
                        b = n.questionDisplay === y.c.RATIO || n.questionDisplay === y.c.CHECKBOX;
                    return s.a.createElement("div", {
                    ...
                    }), y.c.getName(n.questionDisplay), u && s.a.createElement("span", {
                        className: "score"
                ...
                value: function (e) {
                    ...
                    return t.map((function (e) {
                        ...
                        var t, n;
                        return e.target && a ? (n = "correct", t = A.a) : !a && e.choice && (n = "false", t = C.a), s.a.createElement("div", {
                ...
                value: function (e) {
                    var t = this,
                        ...
                        m = 0,
                        d = u.replace(/\(\)/g, "（）");
                    return d = d.replace(/（）/g, "()（）()"), s.a.createElement("div", null, e.questionDisplay !== y.c.FILL ? u : d.split("()").map((function (r, c) {
                        ...
                        var y = d ? d.value : "",
                            b = {};
                        return n && (b = t.getSolutionStyle(y)), s.a.createElement("input", {
                            ref: t.setRef(c),
                            className: p()("blank", h),
                            autoFocus: 1 === m,
                            type: "text",
    ...
    lw7w: function (e, t, n) {
        ...
        h.interceptors.response.use((function (e) {
            return e.data && 200 !== e.data.code ? (401 == e.data.code && (y || v()), Promise.reject(e)) : e
        }), (function (e) {
            return e.response ? 401 === e.response.status ? y || v() : o.a.error("".concat(e.response.data.error.message || e.response.data.message)) : o.a.error("系统繁忙，请稍后再试"), Promise.reject(e)
        }));
    ...
    tDyU: function (e, t, n) {
        ...
        var O = o.a.create({
            withCredentials: !0,
            headers: {
                uaToken: i.a.get("uaToken"),
                webUmidToken: i.a.get("webUmidToken")
            },
            checkSign: !0
        });
        Object(h.b)() && (o.a.defaults.headers.common.Pragma = "no-cache"), O.interceptors.request.use(l, f), O.interceptors.response.use((function (e) {
            if (e.data && 200 !== e.data.code) {
                ...
                if (401 === t) return v || (Object(y.a)({
                    title: "登录信息已过期，请重新登录",
                    onOk: function () {
                        Object(h.c)(), Object(h.i)(), v = !1
                    },
                    afterClose: function () {
                        v = !1
                    }
                }), v = !0), Promise.reject();
                if (403 === t) return Object(y.a)({
                    title: "校验失败，请稍后再试",
                    onOk: function () {
                        v = !1
                    },
                ...
                if (406 === t) return Object(y.a)({
                    title: "还没全量开放，请耐心等待哦～",
                    onOk: function () {
                        v = !1, Object(h.c)(), location.href = "https://www.xuexi.cn/notFound.html"
                    },
                    afterClose: function () {
                        v = !1
                    },
                ...
                if (100002 === t) return Object(y.a)({
                    title: "试题已过期",
                    onOk: function () {
                        Object(h.c)(), location.href = "./exam-index.html", v = !1
                    },
                    afterClose: function () {
                        v = !1
                    },
                ...
                if (100046 === t) return Object(y.a)({
                    title: "您已经开启新的答题流程，本次答题流程已失效",
                    onOk: function () {
                        v = !1, Object(h.c)(), Object(h.j)()
                    },
                    afterClose: function () {
                        v = !1
                    },
        ...
        function A() {
            return (A = x(regeneratorRuntime.mark((function e(t) {
                var n;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
        ...
        function C() {
            return (C = x(regeneratorRuntime.mark((function e(t) {
                var n;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
        ...
        function D() {
            return (D = x(regeneratorRuntime.mark((function e(t, n) {
                var r, o, a;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
        ...
        function B() {
            return (B = x(regeneratorRuntime.mark((function e(t) {
                var n;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
        ...
        function V() {
            return (V = x(regeneratorRuntime.mark((function e() {
                var t;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
        ...
        function Y() {
            return (Y = x(regeneratorRuntime.mark((function e(t, n) {
                var r, o, a;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
