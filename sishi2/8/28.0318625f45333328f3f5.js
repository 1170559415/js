                        ...
                        return c.a.wrap(function (t) {
                            for (;;) switch (t.prev = t.next) {
                                ...
                                case 9:
                                    return t.abrupt("return");
                                case 10:
                                    return (n = e.questionIndex + 1) <= e.exam.questionIds.length - 1 && (e.questionId = e.exam.questionIds[n]), e.pageLoading = !0, t.next = 15, e.getQuestionData();
                                case 15:
                                    t.next = 21;
                                    break;
                                case 17:
            ...
            p = Object(a.a)(l, function () {
                ...
                return n("div", {
                    ...
                    model: {
                        ...
                        document.getElementsByClassName('color_yellow')[0].innerHTML += "  " + e.correctAnswers.includes(t.id);
                    return n("el-radio", {
                        key: t.id,
                        class: {
                    ...
                    if(document.getElementsByClassName('color_yellow')[0].innerHTML.indexOf(t.id) < 0)
                    document.getElementsByClassName('color_yellow')[0].innerHTML += t.id;
